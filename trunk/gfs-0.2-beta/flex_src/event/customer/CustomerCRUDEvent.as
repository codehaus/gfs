...
package event.customer
{
	...
	import command.customer.CustomerDeleteCommand;
    import command.customer.CustomerCancelCommand;
	...
	public class CustomerCRUDEvent extends CairngormEvent
	{
        ...
        static public var CANCEL_EVENT:String 				= "cancelCustomerEvent";
		...
		public function CustomerCRUDEvent(eventType:String,value:CustomerVO=null,popName:String = null)
		{
			super(eventType);
		...
		private function registersCommands():void
		{
            ...
            ApplicationController.instance.registerCommand(CANCEL_EVENT,CustomerCancelCommand);
		}
	}
}