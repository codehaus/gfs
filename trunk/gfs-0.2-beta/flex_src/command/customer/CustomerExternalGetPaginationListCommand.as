...
package command.customer
{
	...
	import event.customer.CustomerExternalGetPaginationEvent;
	 ...
	 * @since 23-Feb-2009
	 */
	public class CustomerExternalGetPaginationListCommand implements ICommand, IResponder
	{
		private var _model:CustomerModel = ApplicationModelLocator.instance.customerModel;

		public function execute(event:CairngormEvent):void
		{
			var getEvent:CustomerExternalGetPaginationEvent = CustomerExternalGetPaginationEvent(event);
		...
		public function result(data:Object):void
		{
			...
			_model.externalpage = data.result;
		}
