...
package command.customer
{
	 ...
	 * @since 23-Feb-2009
	 */
	public class CustomerDeleteCommand extends AbstractNavigationCommand
	{

        public function CustomerDeleteCommand()
        {
		...
		override public function execute(event:CairngormEvent):void
		{
			...
			new CustomerBusinessDelegate(this).destroy(crudEvent.vo);
