...
package command.company
{
	 ...
	 * @since 23-Feb-2009
	 */
	public class CompanyExternalGetPaginationListCommand implements ICommand, IResponder
	{
		private var _model:CompanyModel = ApplicationModelLocator.instance.companyModel;

		public function execute(event:CairngormEvent):void
		{
			var getEvent:CompanyExternalGetPaginationEvent = CompanyExternalGetPaginationEvent(event);
