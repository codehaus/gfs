...
package command.company
{
	 ...
	 * @since 23-Feb-2009
	 */
	public class CompanySaveOrUpdateCommand extends AbstractNavigationCommand
	{

        public function CompanySaveOrUpdateCommand()
        {
            _navigateKey = "company.edit";
		...
		override public function execute(event:CairngormEvent):void
		{
			...
			new CompanyBusinessDelegate(this).save(crudEvent.vo);
		}
