 ...
 * @since  3-Feb-2009
 */
class ExternalManyToOneBuildFormItem extends AbstractRelationBuildFormItem
{
	/**
	 * Constructor
	 *
	 */
	ExternalManyToOneBuildFormItem(property)
	{
		super(property)
	}
	...
	protected void generateViews(property)
	{
		...
		def classNameDir = "${nameDir}/${property.referencedDomainClass.shortName}ManyToOneView.mxml"
