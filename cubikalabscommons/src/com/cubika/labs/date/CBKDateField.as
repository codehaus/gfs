package com.cubika.labs.date
{
	...
	{	
		public var errorMessage:String = MultipleRM.getSuppliedString(MultipleRM.localePrefix, 'cbkDateField.errorMessage', 'Date is Incorrect');
		...
		private var _formatDate:String = "dd/mm/yyyy";
...
//			setStyle("borderStyle","inset");
		...
		public function set formatDate(value:String):void
		{
			_formatDate = value;
			removeAllChildren();
			createFields();
		...
		public function get formatDate():String
		{
			return _formatDate;
		}
		...
		private function addLabelFormat():void
		{
			...
			label.text = "("+ MultipleRM.getSuppliedString(MultipleRM.localePrefix, 'cbkDateField.formatDate', formatDate.toLocaleLowerCase()) +")";//"("+formatDate.toLocaleLowerCase()+")"
			addChild(label);
		}
