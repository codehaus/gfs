...
public class AutoComplete extends ComboBox 
{
	...
	public function AutoComplete()
	{
		...
		rowCount = 7;
		addEventListener(FlexEvent.VALUE_COMMIT,valueCommit,false,0,true);
	}
	
	private function valueCommit(event:Event):void
	{
		if (defaultSelectedItem && !selectedItem && !defaultApply)
		{
			defaultApply = true;
	 ...
	 * @private 
	 */	
	private var defaultApply:Boolean = false;
	
	/**
	 *	@public 
	 */	
	public var defaultSelectedItem:Object;
