        ...
        private static var FUNCTION_LOADIFRAME:String = 
        	...
        	"{ " +
	            ...
	            "{" +
                    ...
                    "{" +
                        "document.getElementById(frameID).innerHTML = \"<iframe id='\"+iframeID+\"' src='\"+url+\"' frameborder='0' wmode='transparent'></iframe>\";" + 
                    "}" +
                "}" +
            "}";
            ...
            while (current!=null)
            {
                if (current is Container)
                {
                    if (current.contains(previous))
                    {
                        ...
                        settingDict[current] = childIndex;FUNCTION_MOVEIFRAME
