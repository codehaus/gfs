...
/**
 * Extends AbstractRelationBuildFormItem adding external one to many builder
 * functionallity
 * 
 * @author Ezequiel Martin Apfel
 * @since  3-Feb-2009
 */
class ExternalOneToManyBuildFormItem  extends AbstractRelationBuildFormItem
{	
	/**
	 * Constructor
	 *
	 */
	ExternalOneToManyBuildFormItem(property)
	{
		super(property)
	}
	...
	protected void generateViews(property)
	{
		...
		templateDir = resolveResources("/*"+antProp.'view.externalrelationeditfile').toString()
