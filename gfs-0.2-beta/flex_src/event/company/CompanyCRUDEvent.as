...
package event.company
{
	...
	import command.company.CompanyDeleteCommand;
    import command.company.CompanyCancelCommand;
	...
	public class CompanyCRUDEvent extends CairngormEvent
	{
        ...
        static public var CANCEL_EVENT:String 				= "cancelCompanyEvent";
		...
		public function CompanyCRUDEvent(eventType:String,value:CompanyVO=null,popName:String = null)
		{
			super(eventType);
		...
		private function registersCommands():void
		{
            ...
            ApplicationController.instance.registerCommand(CANCEL_EVENT,CompanyCancelCommand);
		}
	}
}