...
package model
{
	...
	public class ApplicationModelLocator
	{
		...
		/*PROPERTIES*/
		private var _customerReportingModel:CustomerReportingModel;
		...
		/*GETTERS*/
		public function get customerReportingModel():CustomerReportingModel
		{
			if (!_customerReportingModel)
				_customerReportingModel = new CustomerReportingModel();
			return _customerReportingModel
		}
