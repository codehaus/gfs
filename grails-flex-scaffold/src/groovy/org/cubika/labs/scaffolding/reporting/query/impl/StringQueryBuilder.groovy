 ...
 * @since  2-Mar-2009
 */
public class StringQueryBuilder extends AbstractQueryBuilder
{
	/**
	 * @see org.cubika.labs.scaffolding.reporting.query.impl.AbstractQueryBuilder
	 */
	StringQueryBuilder(prop,valueString,queryObject)
	{
		super(prop,valueString,queryObject)
		println("String valueString ::::::::" +valueString);
	}
	/**
	 * @see org.cubika.labs.scaffolding.reporting.query.impl.AbstractQueryBuilder
	 */
	def build()
	{
		String result = propName+" like ? "+DEFAULT_QUERY_ASSOCIATION
		queryObject.queryString += result
		queryObject.queryParameters.add('%'+valueString+'%')
	}
}
