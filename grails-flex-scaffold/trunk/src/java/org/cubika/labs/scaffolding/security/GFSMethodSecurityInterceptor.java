 ...
 * @author T.Yamamoto
 */
public class GFSMethodSecurityInterceptor extends MethodSecurityInterceptor {
	...
	public Object invoke(final MethodInvocation mi) throws Throwable {
		...
		//getObjectDefinitionSource().getAttributes(mi);
		
		//super.setValidateConfigAttributes(false);
		
		//obtainObjectDefinitionSource();
		
        //super.setValidateConfigAttributes(true);
